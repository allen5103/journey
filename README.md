...
[開啟公開版本](https://allen5103.github.io/journey/) · [查看最新版本](https://allen5103.github.io/journey/?v=1.6.2)

目前公開版本：**v1.6.2**。本版將旅程詳情四個操作按鈕統一為 DAY 卡片式白底、柔和邊框與陰影，並保留圖示色彩辨識；請在應用程式的「設定」頁查看實際載入的版本號。
