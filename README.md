...
[開啟公開版本](https://allen5103.github.io/journey/) · [查看最新版本](https://allen5103.github.io/journey/?v=1.6.5)

目前公開版本：**v1.6.5**。詳情頁的返回、匯出、編輯與刪除按鈕改為與行程標題一致的墨綠色，並縮小垂直尺寸；空白行程加號仍維持旅程選取色且可直接開啟新增行程表單。請在應用程式的「設定」頁查看實際載入的版本號。
