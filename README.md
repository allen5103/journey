...
[開啟公開版本](https://allen5103.github.io/journey/) · [查看最新版本](https://allen5103.github.io/journey/?v=1.6.3)

目前公開版本：**v1.6.3**。新建旅程會預先選取主題綠 Almost Aqua，且此色塊固定在八色選色列最左側第一個；既有旅程的保存色彩不會被變更。請在應用程式的「設定」頁查看實際載入的版本號。
